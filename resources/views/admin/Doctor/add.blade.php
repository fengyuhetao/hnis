                                ...
                                <form action="{{url('admin/admin')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="doc_name" class="form-control" placeholder="请输入姓名">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="doc_seo_keyword" class="form-control" placeholder="请输入seo关键词">
                                                {{--<span class="help-block"> A block of help text. </span>--}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="doc_seo_description" class="form-control" placeholder="请输入seo描述">
                                                {{--<span class="help-block"> A block of help text. </span>--}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    ...
                                                    <div>
                                                                <span class="btn default btn-file">
                                                                    ...
                                                                    <input type="file" name="doc_face"/> </span>
