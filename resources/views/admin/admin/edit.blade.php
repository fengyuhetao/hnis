                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_0">
                        <div class="portlet box blue-hoki">
                            ...
                            @endif
                            <!-- BEGIN FORM-->
                                <form action="{{url('admin/admin')}}/{{$admindata->admin_id}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="admin_name" value="{{$admindata->admin_name}}" class="form-control" placeholder="请输入姓名">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-grosup">
                                                    <div class="icheck-inline">
                                                        <label>
                                                            <input type="radio" name="admin_sex" {{$admindata->admin_sex == "男" ? "checked" : ""}} value="男" class="icheck" data-radio="iradio_square-grey"> 男</label>
                                                        <label>
                                                            <input type="radio" name="admin_sex" {{$admindata->admin_sex == "女" ? "checked" : ""}} value="女" class="icheck" data-radio="iradio_square-grey"> 女</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="admin_email" value="{{$admindata->admin_email}}" class="form-control" placeholder="请输入邮箱"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">账号</label>
                                            <div class="col-md-4">
                                                <input type="text" name="admin_username" value="{{$admindata->admin_username}}" class="form-control" placeholder="请输入账号">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="admin_tel" value="{{$admindata->admin_tel}}" class="form-control" placeholder="请输入电话号码">
                                                <span class="help-block"> </span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <div class="icheck-inline">
                                                        <label>
                                                            <input type="radio" name="admin_state" {{$admindata->state == 0 ? "checked" : ""}} value="0" class="icheck" data-radio="iradio_square-grey"> 禁用</label>
                                                        <label>
                                                            <input type="radio" name="admin_state" {{$admindata->state == 1 ? "checked" : ""}} value="1" class="icheck" data-radio="iradio_square-grey"> 启用</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" style="width: 120px; height: 90px;">
                                                        <img src="{{$admindata->admin_pic ? $admindata->admin_pic : "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image"}}" alt="" /> </div>
                                                ...
                                                @foreach($roles as $v)
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <div class="icheck-inline">
                                                                <label>
                                                                    <input type="checkbox" name="roles[]" {{in_array($v['role_id'], $adminRoles) ? "checked" : ""}} value="{{$v['role_id']}}" class="icheck" data-checkbox="icheckbox_square-grey"> {{$v['role_name']}}<a data-toggle="modal"  onclick="setCurrentRole({{$v['role_id']}}, '{{$v['role_name']}}', '{{$v['role_desc']}}', '{{$v['role_addtime']}}')" href="#long">[查看角色权限]</a>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
