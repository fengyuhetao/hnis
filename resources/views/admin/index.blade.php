...
<div class="page-content">
    ...
    <div class="theme-panel hidden-xs hidden-sm" style="display: none">
        ...
        <div class="theme-options">
            <div class="theme-option theme-colors clearfix">r
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">后台管理首页
        <small>注册用户数, 注册医生数, 表格...</small>
    </h1>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">用户注册</span>
                ...
                <div class="portlet-body">
                    <div id="site_statistics_loading">
                        <img src="{{asset('resources/assets/global/img/loading.gif')}}" alt="loading" /> </div>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">医生注册</span>
                        <span class="caption-helper"></span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <div class="mt-comments">
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar1.jpg')}}" /> </div>
                                ...
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar6.jpg')}}" /> </div>
                                    <div class="mt-comment-body">
                                        <div class="mt-comment-info">
                                ...
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar8.jpg')}}" /> </div>
                                    <div class="mt-comment-body">
                                        <div class="mt-comment-info">
                                ...
                                <div class="mt-comment">
                                    <div class="mt-comment-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar4.jpg')}}" /> </div>
                                    <div class="mt-comment-body">
                                        <div class="mt-comment-info">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="mt-actions">
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar10.jpg')}}" /> </div>
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar3.jpg')}}" /> </div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar2.jpg')}}" /> </div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar7.jpg')}}" /> </div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar9.jpg')}}" /> </div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                        ...
                        <div class="tab-pane" id="tab_actions_completed">
                            ...
                            <div class="mt-actions">
                                ...
                                <div class="mt-action">
                                    <div class="mt-action-img">
                                        <img src="{{asset('resources/assets/pages/media/users/avatar5.jpg')}}" /> </div>
                                    <div class="mt-action-body">
                                        <div class="mt-action-row">
                                            <div class="mt-action-info ">
                                                <div class="mt-action-icon ">
                        ...
                        <div class="events-content">
                            <ol>
                                <li class="selected" data-date="16/01/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{asset('resources/assets/pages/media/users/avatar80_3.jpg')}}" />
                                        </div>
                                ...
                                <li data-date="20/04/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{asset('resources/assets/pages/media/users/avatar80_1.jpg')}}" />
                                        </div>
                                        <div class="mt-author-name">
                                ...
                                <li data-date="20/05/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{asset('resources/assets/pages/media/users/avatar80_2.jpg')}}" />
                                        </div>
                                        <div class="mt-author-name">
                                            <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                        </div>
                                ...
                                <li data-date="30/08/2014">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="mt-content border-grey-steel">
                                        <img class="timeline-body-img pull-left" src="{{asset('resources/assets/pages/media/blog/5.jpg')}}" alt="">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                            qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                            qui ut. laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. </p>
                                ...
                                <li data-date="15/09/2014">
                                    ...
                                    <div class="mt-author">
                                        <div class="mt-avatar">
                                            <img src="{{asset('resources/assets/pages/media/users/avatar80_5.jpg')}}" />
                                        </div>
                                        <div class="mt-author-name">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="mt-content border-grey-steel">
                                        <img class="timeline-body-img pull-right" src="{{asset('resources/assets/pages/media/blog/6.jpg')}}" alt="">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis
                                            qui ut.</p>
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body" id="chats">
                    <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                        <ul class="chats">
                            <li class="out">
                                <img class="avatar" alt="" src="{{asset('resources/assets/layouts/layout/img/avatar2.jpg')}}" />
                                <div class="message">
                            ...
                            <li class="in">
                                <img class="avatar" alt="" src="{{asset('resources/assets/layouts/layout/img/avatar1.jpg')}}" />
                                <div class="message">
                                    <span class="arrow"> </span>
                            ...
                            <li class="out">
                                <img class="avatar" alt="" src="{{asset('resources/assets/layouts/layout/img/avatar3.jpg')}}" />
                                <div class="message">
                                    <span class="arrow"> </span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mt-widget-1">
                                ...
                                <div class="mt-img">
                                    <img src="{{asset('resources/assets/pages/media/users/avatar80_8.jpg')}}"> </div>
                                <div class="mt-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mt-widget-1">
                                ...
                                <div class="mt-img">
                                    <img src="{{asset('resources/assets/pages/media/users/avatar80_7.jpg')}}"> </div>
                                <div class="mt-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mt-widget-1">
                                ...
                                <div class="mt-img">
                                    <img src="{{asset('resources/assets/pages/media/users/avatar80_6.jpg')}}"> </div>
                                <div class="mt-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mt-widget-2">
                                <div class="mt-head" style="background-image: url({{asset('resources/assets/pages/img/background/32.jpg')}};">
                                    <div class="mt-head-label">
                                        <button type="button" class="btn btn-success">Manhattan</button>
                                    </div>
                                    <div class="mt-head-user">
                                        <div class="mt-head-user-img">
                                            <img src="{{asset('resources/assets/pages/img/avatars/team7.jpg')}}"> </div>
                        ...
                        <div class="col-md-6">
                            <div class="mt-widget-2">
                                <div class="mt-head" style="background-image: url({{asset('resources/assets/pages/img/background/43.jpg')}});">
                                    <div class="mt-head-label">
                                        <button type="button" class="btn btn-danger">London</button>
                                    </div>
                                    <div class="mt-head-user">
                                        <div class="mt-head-user-img">
                                            <img src="{{asset('resources/assets/pages/img/avatars/team3.jpg')}}"> </div>
                                        <div class="mt-head-user-info">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mt-widget-4">
                                <div class="mt-img-container">
                                    <img src="{{asset('resources/assets/pages/img/background/34.jpg')}}" /> </div>
                        ...
                        <div class="col-md-4">
                            <div class="mt-widget-4">
                                <div class="mt-img-container">
                                    <img src="{{asset('resources/assets/pages/img/background/46.jpg')}}" /> </div>
                        ...
                        <div class="col-md-4">
                            <div class="mt-widget-4">
                                <div class="mt-img-container">
                                    <img src="{{asset('resources/assets/pages/img/background/37.jpg')}}" /> </div>
...
@section('pluginjs')
    ...
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/amcharts.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/serial.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/pie.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/radar.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/themes/light.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/themes/patterns.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amcharts/themes/chalk.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/ammap/ammap.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/amcharts/amstockcharts/amstock.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/fullcalendar/fullcalendar.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('resources/assets/global/plugins/horizontal-timeline/horizontal-timeline.js')}}" type="text/javascript"></script>
