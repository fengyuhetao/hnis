    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{url('admin/doctor')}}">分类管理</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span>分类列表</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{url('admin/type/create')}}" id="sample_editable" class="btn sbold green"> 添加
...
@endsection
@section('js')
    <script src="{{asset('resources/assets/pages/scripts/table-type-datatables-managed.js')}}" type="text/javascript"></script>
    <script>
